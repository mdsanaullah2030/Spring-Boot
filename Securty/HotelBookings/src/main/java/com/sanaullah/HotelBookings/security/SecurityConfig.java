        ...
        return
                http
                        ...
                        .authorizeHttpRequests(
                                req ->
                                        req.requestMatchers("/login", "/register", "/api/hotel/getHotelsByLocationId","/api/location/findLocationName",
                                                        "/api/hotel/", "api/room/","api/room/{id}", "/api/room/r/searchroombyid", "/api/booking/","/api/booking/save","/activate/**",
                                                        "/api/location/**","/images/**")
                                                .permitAll()
